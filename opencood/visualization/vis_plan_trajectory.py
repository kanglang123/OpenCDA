...
if __name__ == '__main__':
    ...
    opencda_dataset1 = IntermediateFusionDataset(params,visualize=True,
                                            train=False)

    data_loader = DataLoader(opencda_dataset1, batch_size=1, num_workers=8,
                             collate_fn=opencda_dataset1.collate_batch_train,
                             shuffle=False,
                             pin_memory=False)
