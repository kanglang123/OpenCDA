...
class PointPillarIntermediate(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        plan_trajectory  = data_dict['map_mask']
        ...
        # spatial_features_2d = spatial_features_2d[0,:,:,:] * plan_trajectory.view(1,1,100,352)
        plt.imsave('a.png',spatial_features_2d[0][0].detach().cpu().numpy())
        plt.imsave('out.png',plan_trajectory.detach().cpu().numpy())
